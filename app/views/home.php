...
<body>
    ...
    <header class="menuprincipal">
        <nav>
            ...
            <ul class="nav-list">
                <li><a data="inicial" class="aLink" href="#">HOME</a></li>
    ...
    <footer id="contato">
        ...
        <img src="public/assets/images/Logo.png" class="img-fluid"><br>
        ...
        <p><img src="public/assets/images/jgtag.png" id="empresa" class="img-fluid"> Desenvolvido por JGTag</p>
    </footer>
